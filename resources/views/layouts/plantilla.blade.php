...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav ml-auto py-0">
                    ...
                    <a href="{{ route('services') }}" class="nav-item nav-link">Servicios</a>
                    <a href="{{ route('contact') }}" class="nav-item nav-link">Contacto</a>
                    @auth
                        <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                            @csrf
                        </form>
                        <a href="#" class="nav-item nav-link" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Cerrar sesión</a>
                    @else
  ...
  <!-- Carousel Start -->
  <div class="container-fluid p-0" style="margin-bottom: 80px;">
    <div id="header-carousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="w-100" src="img/invernadero.jpg" alt="Image">
      ...
      <div class="row pt-5">
          ...
          <div class="col-lg-3 col-md-6 mb-5 ">
              ...
              <div class="d-flex flex-column justify-content-start">
                  <b class="text-white-50 mb-2" >
                    <svg  width="16" height="16" fill="currentColor" class="bi bi-chevron-compact-right" viewBox="0 0 16 16">
          ...
          <div class="col-lg-3 col-md-6 mb-5">
              ...
              <p><i class="fa fa-map-marker-alt mr-2"></i>Domicilio: Av. Las Cañadas No.501, Colonia Tres Marías, Morelia, México</p>
              <p><i class="fa fa-phone-alt mr-2"></i>(443) 2 98 84 44</p>
              <p><i class="fa fa-envelope mr-2"></i> contacto@softtim.mx</p>
          </div>
      </div>
  </div>
  <div class="container-fluid bg-dark text-white border-top py-4 px-sm-3 px-md-5" style="border-color: rgba(256, 256, 256, .1) !important;">
      <div class="row">
          ...
          <div class="col-lg-6 text-center text-md-right">
              <p class="m-0 text-white-50">Designed by <a href="https://softtim.mx/">SoftTIM</a>
              </p>
          </div>
      </div>
  </div>
